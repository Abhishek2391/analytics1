#how to group the flowrs as per the length and shape of petals
#Optimal Number of Clusters in data
#remove the existing label,i.e the last column
...
#calculate aggregate of each group to find average of each group
#ID numbers should not be used to create clusters
